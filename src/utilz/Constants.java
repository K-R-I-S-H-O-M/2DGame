...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int RED_POTION_VLAUE = 10;
		public static final int BLUE_POTION_VLAUE = 15;
		...
		public static final int POTIOIN_WIDTH_DEFAULT = 12;
		public static final int POTIOIN_HEIGHT_DEFAULT = 12;
		public static final int POTION_WIDTH = (int) (Game.SCALE * POTIOIN_WIDTH_DEFAULT);
		public static final int POTION_HEIGHT = (int) (Game.SCALE * POTIOIN_HEIGHT_DEFAULT);
	...
	public static class UI {
		...
		public static class URMBUTTON {
			public static final int URM__DEFAULT_SIZE = 56;
			public static final int URM_SIZE = (int) (URM__DEFAULT_SIZE * Game.SCALE);
		}
